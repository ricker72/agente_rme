"""
Health Widget for Agente RME Studio Dashboard.
...
class HealthWidget(QFrame):
    """Widget displaying health status indicators."""
    ...
    def __init__(self, parent=None) -> None:
        ...
        self.setObjectName("health_widget")
    ...
    def _build_ui(self) -> None:
        ...
        # Title
        self._title_label = QLabel("Health Status", self)

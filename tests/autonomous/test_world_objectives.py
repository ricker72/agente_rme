...
class TestWorldObjective:
    ...
    def test_evaluate_below_target(self):
        obj = WorldObjective(
            objective_type=ObjectiveType.QUALITY, target_value=0.8, weight=1.0
        )
    ...
    def test_evaluate_above_target_caps_at_one(self):
        obj = WorldObjective(
            objective_type=ObjectiveType.QUALITY, target_value=0.5, weight=1.0
        )
    ...
    def test_threshold_penalty(self):
        obj = WorldObjective(
            objective_type=ObjectiveType.QUALITY,
            target_value=0.9,
            threshold=0.5,
            weight=1.0,
        )
    ...
    def test_get_status_in_progress(self):
        obj = WorldObjective(
            objective_type=ObjectiveType.QUALITY, target_value=0.9, threshold=0.5
        )
        obj.evaluate(0.6)
    ...
    def test_to_dict_from_dict(self):
        obj = WorldObjective(
            objective_type=ObjectiveType.QUALITY, target_value=0.9, weight=0.5
        )
        data = obj.to_dict()
    ...
    def test_all_objective_types(self):
        for t in (
            ...
            ObjectiveType.DENSITY,
            ObjectiveType.NAVIGATION,
            ObjectiveType.BOSS,
            ObjectiveType.CITY,
            ObjectiveType.DIFFICULTY,
            ObjectiveType.PLAYTEST,
            ObjectiveType.CRITIC,
            ObjectiveType.REUSE,
        ):

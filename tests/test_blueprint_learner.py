...
from core.learning.blueprint_ranker import BlueprintRanker, RankedBlueprint
from core.learning.blueprint_catalog import BlueprintCatalog, BlueprintIndexEntry
...
def _make_sample_houses(count: int = 3) -> List[Dict[str, Any]]:
    ...
    return [{
        "id": i + 1, "name": f"House {i}",
        "temple_x": i * 20 + 5, "temple_y": i * 15 + 5, "temple_z": 7,
    } for i in range(count)]
...
class TestBlueprintCatalog(unittest.TestCase):
    ...
    def test_by_category(self):
        ...
        self.catalog.add_blueprint(_make_sample_blueprint("t1", "temple", "temple", 50))
        self.catalog.add_blueprint(_make_sample_blueprint("h1", "hunt", "hunting", 50))
        self.catalog.add_blueprint(_make_sample_blueprint("d1", "dungeon", "dungeon", 50))
    ...
    def test_search(self):
        ...
        self.catalog.add_blueprint(_make_sample_blueprint("temple_main", "temple", "temple", 50))
        self.catalog.add_blueprint(_make_sample_blueprint("dungeon_boss", "dungeon", "dungeon", 50))
    ...
    def test_statistics(self):
        ...
        self.catalog.add_blueprint(_make_sample_blueprint("t1", "temple", "temple", 100))
        self.catalog.add_blueprint(_make_sample_blueprint("t2", "temple", "temple", 150))
    ...
    def test_theme_statistics(self):
        ...
        self.catalog.add_blueprint(_make_sample_blueprint("t1", "temple", "temple", 100))
        self.catalog.add_blueprint(_make_sample_blueprint("t2", "temple", "temple", 200))
...
class TestBlueprintLearner(unittest.TestCase):
    ...
    def test_blueprint_to_vector(self):
        ...
        self.assertEqual(len(vector), 20 + 30 + 3 + 15 + 13 + 2)  # grounds + items + struct + themes + categories + meta

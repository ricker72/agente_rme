...
# boss structure
w.add_structure(Structure(name='boss_arena', category='boss_room', x=15, y=15, z=7, width=10, height=10, tags=['boss']))

critic = VisualCritic()
result = critic.analyze(w, map_name='test_issavi', output_dir='output/critic_test', generate_heatmaps=True)

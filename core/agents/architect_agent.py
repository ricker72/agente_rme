...
class ArchitectAgent(BaseAgent):
    ...
    def execute(self, request: Any) -> Dict[str, Any]:
        ...
        world_width = getattr(request, "world_width", 512) if hasattr(request, "world_width") else 512
        world_height = getattr(request, "world_height", 512) if hasattr(request, "world_height") else 512
        ...
        return {
            ...
            "world_plan": world_plan.to_dict() if world_plan and hasattr(world_plan, "to_dict") else None,

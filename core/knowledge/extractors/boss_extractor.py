        ...
        for s in _as_list(world.get("structures")):
            ...
            entries.append(KnowledgeEntry.build(
                ...
                attributes={
                    ...
                    "shape": "circular" if any(t in tags for t in self.CIRCULAR_ARENA_TYPES) else "rectangular",
                    "size": area,
        ...
        for r in _as_list(world.get("regions")):
            ...
            entries.append(KnowledgeEntry.build(
                ...
                attributes={
                    ...
                    "shape": "circular" if any(kw in lname for kw in ("arena", "throne", "coliseum")) else "rectangular",

...
THEME_LORE: Dict[str, List[Dict[str, str]]] = {
    "Issavi": [
        ...
        {
            "title": "The Crystal of Issavi",
            "category": "myth",
            "content": "Legends speak of a crystal hidden beneath the city that can seal the demonic portal forever.",
            "importance": 4,
        },
        {
            "title": "The Last Stand of the Issavi Guard",
            "category": "legend",
            "content": "Captain Thalor led the final defense of the city gates, buying time for civilians to escape.",
            "importance": 3,
        },
    ],
    "Darashia": [
    ...
    "Roshamuul": [
        {
            "title": "The Cursed Isle",
            "category": "history",
            "content": "Roshamuul was once a prosperous trading hub until a plague of undeath consumed its population.",
            "importance": 5,
        },
        {
...
FACTION_LORE_TEMPLATES: Dict[str, List[str]] = [
    ...
    "Members of the {faction} swear an oath upon admission to protect the secrets of their order until death.",
...
class LoreGenerator:
    ...
    def generate(
        ...
        for i in range(remaining):
            ...
            faction = (
                faction_names[i % len(faction_names)] if faction_names else "The Order"
            )
    ...
    def generate_prophecy(
        self, theme: str, factions: Optional[List[str]] = None
    ) -> LoreEntry:
    ...
    def generate_secret(self, theme: str, npc_name: Optional[str] = None) -> LoreEntry:
        """Generate a hidden secret entry."""
        npc_text = (
            f"discovered by {npc_name}" if npc_name else "hidden in ancient texts"
        )
        return LoreEntry(

...
class BlueprintLearner:
    ...
    def learn_from_otbm(
        ...
        try:
            ...
            # 2. Extract blueprint
            extraction = self.extractor.extract_from_otbm(otbm_path, save=save_blueprints)
    ...
    def learn_from_analysis(
        ...
        try:
            # Extract blueprint
            extraction = self.extractor.extract_from_analysis(analysis, save=save_blueprint)
    ...
    def _encode_theme(self, theme: str) -> List[float]:
        ...
        themes = [
            "generic", "temple", "dungeon", "city", "hunt", 
            "issavi", "roshamuul", "yalahar", "jungle", "ice",
            "soulwar", "library", "falcon", "cobra", "thais"
        ]
    ...
    def _encode_category(self, category: str) -> List[float]:
        ...
        cats = [
            "unknown", "temple", "dungeon", "city", "hunting",
            "wilderness", "market", "bridge", "camp", "house",
            "boss_room", "depot", "arena"
        ]
    ...
    def get_blueprint_recommendations(self, blueprint_name: str, count: int = 5) -> List[Dict[str, Any]]:

...
class WorldBuilder:
    ...
    def _place_city_tiles(self, world_model: WorldModel, city: dict) -> None:
        ...
        if self.collision.validate(world_model, x, y, z, 12, 10):
            self.structurer.place(world_model, x, y, z, width, height, ground="floor")
    ...
    def _place_dungeon_tiles(self, world_model: WorldModel, dungeon: dict) -> None:
        ...
        height = 18
        if self.collision.validate(world_model, x, y, z, 8, 8):
            self.structurer.place(
                world_model, x, y, z, width, height, ground="stone_floor"
            )

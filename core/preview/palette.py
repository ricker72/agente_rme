...
WALL_IDS = {1495, 1496, 1497, 1498, 1499, 1500, 1501, 1502, 1503, 1504, 1505, 1506, 1507, 1508, 1509}
GROUND_IDS = {415, 393, 421, 1053, 1056, 1057, 396, 397, 398, 514, 513, 516, 428, 429, 430}
WATER_IDS = {4821, 4822, 4823, 4824, 4825, 4826}
DECORATION_IDS = {2153, 2117, 1803, 2150, 2151, 2152, 2148, 2149, 2154, 2155, 2156, 2157, 2158, 2159, 2160}

# Lista de monstruos considerados "boss" para renderizado especial
BOSS_MONSTERS = {
    "Demon", "Dragon", "Behemoth", "Ferumbras", "Orshabaal",
    "Ghazbaran", "Morgaroth", "Zulazza", "The Noxious Spawn",
    "The Pale Worm", "The Many", "Ocyakao", "The Imperor",
    "Plagirath", "The Weakened Frazzlemaw", "The Abomination",
}

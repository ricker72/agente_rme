...
def build_certification(
    *,
    ...
    return {
        ...
        "certification": "WGL10_DYNAMIC_POPULATION_ACTIVE" if certified else None,
        "mission": "WGL-10 Dynamic Population Layer",
        ...
        "next_milestone": "WGL-11 World Integration & Export Layer",
    }

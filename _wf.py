"""BlueprintFusion model — vector representation of a blueprint."""
...
@dataclass
class BlueprintFusion:
    """
    Numerical fusion of a blueprint's structural features.
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> BlueprintFusion:
        return cls(
    ...
    def similarity_to(self, other: BlueprintFusion) -> float:
        """Cosine similarity to another fusion."""
